"""
Django settings for noisy_disk_dev_66756 project.
...
ROOT_URLCONF = 'noisy_disk_dev_66756.urls'
...
WSGI_APPLICATION = 'noisy_disk_dev_66756.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_disk_dev_66756 API",
    "DESCRIPTION": "API documentation for noisy_disk_dev_66756 App",
    "VERSION": "v1",
}
